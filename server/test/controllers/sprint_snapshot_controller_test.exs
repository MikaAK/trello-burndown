defmodule TrelloBurndown.SprintSnapshotControllerTest do
  ...
  @valid_attrs %{date: "2010-04-17", points_complete: 42, points_dev_complete: 42, points_left: 42, sprint_id: 42, sprint_team_snapshot_id: 42}
  @invalid_attrs %{}
  ...
  test "shows chosen resource", %{conn: conn} do
    ...
    assert json_response(conn, 200)["data"] == %{"id" => sprint_snapshot.id,
      ...
      "sprint_team_snapshot_id" => sprint_snapshot.sprint_team_snapshot_id}
  end
